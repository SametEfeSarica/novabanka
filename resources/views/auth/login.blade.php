...
<head>
    ...
    <title>NovaBanka - Giriş Yap</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-left::before {
            ...
            inset: 0;
            background:
                linear-gradient(135deg, rgba(0,229,180,0.04) 0%, transparent 50%),
                radial-gradient(ellipse at 20% 50%, rgba(0,184,255,0.06) 0%, transparent 60%);
        }
        ...
        .btn-login:hover {
            ...
            box-shadow: 0 12px 32px rgba(0,229,180,0.35);
        }
    ...
    <div class="left-content">
        ...
        <div class="features">
            ...
            <div class="feature-item">
                <div class="feature-icon">⚡</div>
                <div class="feature-text">
                    <h4>Anlık Transfer</h4>
                    <p>IBAN ile saniyeler içinde</p>
                </div>
            </div>
            <div class="feature-item">
                <div class="feature-icon">📈</div>
                <div class="feature-text">
                    <h4>Borsa & Kripto</h4>
                    <p>Anlık fiyatlarla alım satım</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="auth-right">
    <h2 class="auth-form-title">Tekrar Hoş Geldiniz 👋</h2>
    ...
    <div class="register-link">
        Hesabınız yok mu? <a href="{{ route('register') }}">Şimdi Aç</a>
    </div>
</div>
</body>
</html>